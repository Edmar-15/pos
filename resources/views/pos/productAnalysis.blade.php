    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="menu">
            ...
            <ul class="menu shown" id="droplist">
                ...
                <li class="menu-item active"><a href="{{ route('pos.report.product.analysis') }}"><span class="icon"><i class="bi bi-graph-down"></i></span> Product Info</a></li>
                <li class="menu-item"><a href="{{ route('pos.report.profits') }}"><span class="icon"><i class="bi bi-graph-down"></i></span> Profits & Loss</a></li>
            </ul>
        </nav>
        ...
        .then(data => {
            ...
            data.forEach(product => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-3 ${product.remaining_stock < 100 ? 'text-red-600 font-semibold' : ''}">${product.remaining_stock}</td>
                `;
